...
let directory = '../data_scryfall/testTypesAndCreatures';
// let types =[];
...
async function getCreaturesAndTypes(data) {
  ...
  //   console.log('Saved!');
  // });
  fs.writeFileSync(directory + 'creatures.js', 'export default ' + util.inspect(mainCreatures, { maxArrayLength: null, showHidden: false, depth: null }), function (err) {
    if (err) throw err;
    console.log('Saved!');
  });
